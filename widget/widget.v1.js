(function () {
  ...
  style.textContent =
    '.qfix-widget{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;display:inline-flex;flex-wrap:wrap;gap:8px;margin:4px 0}' +
  ...
  var SERVICE_ORDER = ["repair", "adjustment", "care"];
  ...
  function initWidgets() {
    ...
    elements.forEach(function (el) {
      ...
      var requested = el.getAttribute("data-qfix");
      var keys;
      if (requested && requested !== "" && requested !== "true") {
        keys = [requested];
      } else {
        keys = SERVICE_ORDER;
      }
      ...
      keys.forEach(function (key) {
        ...
        a.href = API_BASE + "/" + brand + "/" + key + "/?productId=" + productId;
        a.target = "_blank";
        a.rel = "noopener";
